...
function HomePage() {
  return (
    <>
      <Head>
        <title>radical-football63</title>

        <meta
          name="description"
          content="Empower Your Players with Radical-Football63: The Ultimate Youth Soccer Academy Management Platform for Personalized Coaching and Accelerated Development."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              Empower Your Players with Radical-Football63: The Ultimate Youth Soccer Academy Management Platform for
