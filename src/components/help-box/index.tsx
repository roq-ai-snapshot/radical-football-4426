...
export const HelpBox: React.FC = () => {
  ...
  const applicationName = 'radical-football63';
...
3. As a Player, I want to be able to communicate with my coach and teammates through the platform, so I can ask questions, share feedback, and stay connected with my team.
